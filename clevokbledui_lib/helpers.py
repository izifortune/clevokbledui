...
from . clevokbleduiconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('clevokbledui')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('clevokbledui_lib')
